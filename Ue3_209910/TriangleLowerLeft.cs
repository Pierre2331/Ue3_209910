// <copyright file="TriangleLowerLeft.cs" company="PlaceholderCompany">
...
{
    /// <summary>
    /// Defines a triangle shape with the right angle at the lower left corner.
    /// </summary>
    public class TriangleLowerLeft : Triangle
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TriangleLowerLeft"/> class.
        /// </summary>
        ...
        public TriangleLowerLeft(int height, char symbol, ConsoleColor foregroundColor, ConsoleColor backgroundColor, int originX, int originY)
            : base(height, symbol, foregroundColor, backgroundColor, originX, originY)
        {
        }

        /// <summary>
        /// This method renders the triangleLowerLeft to the console.
        /// </summary>
