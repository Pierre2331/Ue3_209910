// <copyright file="TriangleLowerRight.cs" company="PlaceholderCompany">
...
{
    /// <summary>
    /// Defines the triangle shape with the right angle at the lower right corner.
    /// </summary>
    public class TriangleLowerRight : Triangle
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TriangleLowerRight"/> class.
        /// </summary>
        ...
        public TriangleLowerRight(int height, char symbol, ConsoleColor foregroundColor, ConsoleColor backgroundColor, int originX, int originY)
            : base(height, symbol, foregroundColor, backgroundColor, originX, originY)
        {
        }

        /// <summary>
        /// This method renders the triangleLowerRight to the console.
        /// </summary>
